...
namespace meow::core::objects {
    ...
    public:
        ...
        [[nodiscard]] inline value_return_t get(size_t index) const noexcept {
        ...
        [[nodiscard]] inline value_return_t at(size_t index) const {
            return elements_.at(index);
        }
        inline value_return_t operator[](size_t index) const noexcept { return elements_[index]; }
        inline reference_t operator[](size_t index) noexcept { return elements_[index]; }
        [[nodiscard]] inline value_return_t front() const noexcept { return elements_.front(); }
        [[nodiscard]] inline reference_t front() noexcept { return elements_.front(); }
        [[nodiscard]] inline value_return_t back() const noexcept { return elements_.back(); }
