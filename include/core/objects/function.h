...
namespace meow::core::objects {
    ...
    public:
        ...
        inline void close(value_param_t value) noexcept { 
            closed_ = value; 
            state_ = State::CLOSED; 
        }
        inline bool is_closed() const noexcept { return state_ == State::CLOSED; }
        inline value_return_t get_value() const noexcept { return closed_; }
    ...
    private:
        ...
        using container_t = std::vector<UpvalueDesc>;

        size_t num_registers_;
        size_t num_upvalues_;
        string_t name_;
        chunk_t chunk_;
        container_t upvalue_descs_;
    public:
    ...
    private:
        ...
        using container_t = std::vector<upvalue_t>;

        proto_t proto_;
        container_t upvalues_;
    public:
