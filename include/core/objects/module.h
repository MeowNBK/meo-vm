...
namespace meow::core::objects {
    ...
    public:
        ...
        // --- Globals ---
        [[nodiscard]] inline value_return_t get_global(string_t name) noexcept { return globals_[name]; }
        [[nodiscard]] inline void set_global(string_t name, value_param_t value) noexcept { globals_[name] = value; } 
        [[nodiscard]] inline bool has_global(string_t name) { return globals_.find(name) != globals_.end(); }

        // --- Exports ---
        [[nodiscard]] inline value_return_t get_export(string_t name) noexcept { return exports_[name]; }
        [[nodiscard]] inline void set_export(string_t name, value_param_t value) noexcept { exports_[name] = value; }
